...
public class MatrixTesterOS {
    ...
    public static void main (String[] args) {
        ...
        System.out.println(J.rotateCW());
        System.out.println("\tRotated 2 times:");
        System.out.println(J.rotateCW().rotateCW());
        System.out.println("Rotated 4 times (should be the original):");
        System.out.println(J.rotateCW().rotateCW().rotateCW().rotateCW());        
        ...
        System.out.println("\tThe 'Rotated' Matrix:");
        System.out.println(K.rotateCounterCW());
        System.out.println("\tRotated 2 times:");
        System.out.println(K.rotateCounterCW().rotateCounterCW());
        System.out.println("Rotated 4 times (Should be original Matrix:)");
        System.out.println(K.rotateCounterCW().rotateCounterCW().rotateCounterCW().rotateCounterCW());        
    }
}